...
if get(g:, 'airline#themes#base16#constant', 0)
  ...
  function! airline#themes#base16#refresh()
    ...
    let s:N1_tmp = airline#themes#get_highlight2(['DiffText', 'fg'], ['DiffText', 'bg'], 'bold')
    let s:N2_tmp = airline#themes#get_highlight2(['Visual', 'bg'], ['Visual', 'fg'])
    let s:N3_tmp = airline#themes#get_highlight('CursorLine')
    let s:N1 = [s:N1_tmp[0], 'NONE', s:N1_tmp[2], 'NONE']
    let s:N2 = [s:N2_tmp[0], 'NONE', s:N2_tmp[2], 'NONE']
    let s:N3 = [s:N3_tmp[0], 'NONE', s:N3_tmp[2], 'NONE']
    let g:airline#themes#base16#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
    ...
    let s:I1_tmp = airline#themes#get_highlight2(['DiffText', 'bg'], ['DiffAdded', 'fg'], 'bold')
    let s:I2_tmp = airline#themes#get_highlight2(['DiffAdded', 'fg'], ['Normal', 'bg'])
    let s:I1 = [s:I1_tmp[1], 'NONE', s:I1_tmp[3], 'NONE']
    let s:I2 = [s:I2_tmp[0], 'NONE', s:I2_tmp[2], 'NONE']
    let s:I3 = s:N3
    ...
    let s:R1_tmp = airline#themes#get_highlight2(['DiffText', 'bg'], ['WarningMsg', 'fg'], 'bold')
    let s:R1 = [s:R1_tmp[1], 'NONE', s:R1_tmp[3], 'NONE']
    let s:R2 = s:N2
    let s:R3 = s:N3
    ...
    let s:V1_tmp = airline#themes#get_highlight2(['DiffText', 'bg'], ['Constant', 'fg'], 'bold')
    let s:V2_tmp = airline#themes#get_highlight2(['Constant', 'fg'], ['Normal', 'bg'])
    let s:V1 = [s:V1_tmp[1], 'NONE', s:V1_tmp[3], 'NONE']
    let s:V2 = [s:V2_tmp[0], 'NONE', s:V2_tmp[2], 'NONE']
    let s:V3 = s:N3
    ...
    " Warnings
    let s:WI = airline#themes#get_highlight2(['WarningMsg', 'fg'], ['WarningMsg', 'bg'], 'bold')
    let g:airline#themes#base16#palette.normal.airline_warning = [
         \ s:WI[0], 'NONE', s:WI[2], 'NONE'
         \ ]
    ...
    " Errors
    let s:ER = airline#themes#get_highlight2(['ErrorMsg', 'fg'], ['ErrorMsg', 'bg'], 'bold')
    let g:airline#themes#base16#palette.normal.airline_error = [
         \ s:ER[0], 'NONE', s:ER[2], 'NONE'
         \ ]
